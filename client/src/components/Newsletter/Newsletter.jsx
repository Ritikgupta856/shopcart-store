    ...
    <div className="h-[70vh] flex items-center py-4 px-4 w-full bg-newsletter bg-cover" >
      <div className="flex flex-col items-center mx-auto my-0 gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          ...
          <input type="text" placeholder="Email Address" className="outline-none border-neutral-500/0.2 border px-3 py-2 w-[25vw]" />
          <button className="bg-[#8e2de2] text-white py-2 px-6 hover:scale-90">Subscribe</button>
